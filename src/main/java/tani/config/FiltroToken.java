...
import tani.dto.otros.MensajeDTO;
...
public class FiltroToken extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        response.addHeader("Access-Control-Allow-Origin", "https://tani-front-543899402004.us-central1.run.app"); // Permitir solo tu frontend// Permitir solo tu frontend
